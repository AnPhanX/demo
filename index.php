...
<head>
  ...
  <title>DICO STORE</title>

  <link rel="shortcut icon" href="./assets/images/icon/dico.ico" />
...
<body>
  ...
  <div id="fb-customer-chat" class="fb-customer-chat">
  </div>
  
  <script>
    var chatbox = document.getElementById('fb-customer-chat');
    chatbox.setAttribute("page_id", "61559700440836");
