...
<section class="checkout pd-section">
    <div class="container">
        <form action="site/handle/checkout.php" method="POST">
            <div class="row">
                            ...
                            ?>
                                    <div class="checkout__item d-flex align-center">
                                        ...
                                        <div class="checkout__name flex-1">
                                            <h3 class="h7" style="margin: 0; margin-bottom: 6px;"><?php echo $cart_item['product_name'] ?></h3>
                                        ...
                                        <div class="h6 checkout__price"><?php echo (number_format(($product['product_price'] - ($product['product_price'] / 100 * $product['product_sale']))* $cart_item['product_quantity'])) . ' ₫' ?></div>
                                    </div>
                                <?php
                                }
                            } else {
