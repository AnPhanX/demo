<?php
    $sql_category_list = "SELECT * FROM category ORDER BY category_id ASC LIMIT 2";
...
<section class="collage pd-top">
    <div class="container">
        ...
        <div class="collage__items d-grid">
            ...
            ?>
            <div class="collage__item d-flex flex-column h-100 collage__item--large ">
                <div class="collage__image h-100">
                    <img class="w-100 h-100 d-block object-fit-cover flex-1"
                        src="admin/modules/category/uploads/<?php echo $row['category_image']; ?>" alt="image banner" />
                </div>
                <div class="collage__container">
                    <div class="collage__content d-flex">
                        <a class="align-center"
                            href="index.php?page=product_category&category_id=<?php echo $row['category_id'] ?>">
