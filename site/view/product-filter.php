                        ...
                        <div class="sidebar__item--content product-detail__variant--items d-flex">
                            <div class="price__range">
                                ...
                                <div class="range-input">
                                    <input type="range" class="range-min" min="0" max="5000000" value="0" step="50000">
                                    <input type="range" class="range-max" min="0" max="5000000" value="5000000" step="50000">
                                </div>
                                <div class="price-input d-flex space-between">
                                    ...
                                    <div class="field">
                                        <input type="number" id="price-to" class="input-max h4" value="5000000">
                        ...
                        <div class="col" style="--w: 9; --w-md: 4">
                            <div class="product__card d-flex flex-column">
                                ...
                                <div class="product__info">
                                    <a href="index.php?page=product_detail&product_id=<?php echo $row['product_id'] ?>">
                                        <h3 class="product__name h7"><?php echo $row['product_name'] ?></h3>
                                    </a>
                                    <span class="review-star-list d-flex justify-center">
                                        <?php
