                ...
                <div class="col" style="--w: 6; --w-md: 3">
                    <div class="product__card d-flex flex-column">
                        ...
                        <div class="product__info">
                            <a href="index.php?page=product_detail&product_id=<?php echo $row['product_id'] ?>">
                                <h3 class="product__name h7"><?php echo mb_strimwidth($row['product_name'], 0, 50, "...") ?></h3>
                            </a>
                            ...
                            <!-- <a href="index.php?page=product_detail&product_id=<?php echo $row['product_id'] ?>">
                                <div class="product__price align-center d-flex justify-center">
                                    ...
                                    if ($row['product_sale'] > 0) {
                                    ?>
                                        <del class="product__price--old "><?php echo number_format($row['product_price']) . ' ₫' ?></del>
                                    <?php
                                    }
                                    ?>
                                    <span class="product__price--new "><?php echo (number_format($row['product_price'] - ($row['product_price'] / 100 * $row['product_sale'])) . ' ₫') ?></span>
                                </div>
                            </a> -->
                            <div class="product__price align-center d-flex justify-center">
                                    <?php
