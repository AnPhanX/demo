...
<div class="slider-banner">
    ...
    <div class="mySlides banner__box d-flex p-relative banner__medium w-100">
        <div class="image__banner image__item p-absolute" style="--w: 12">
            <img class="w-100 h-100 d-block object-fit-cover" src="./assets/images/banner/banner_product-2.png" alt="banner1" />
        </div>
    ...
    <div class="mySlides banner__box d-flex p-relative banner__medium w-100">
        <div class="image__banner image__item p-absolute" style="--w: 12">
            <img class="w-100 h-100 d-block object-fit-cover" src="./assets/images/banner/banner-5.png" alt="banner1" />
        </div>
        <!-- <div class="banner__overlay p-absolute"></div> -->
    ...
    <!-- <div class="mySlides banner__box d-flex p-relative banner__medium w-100">
        <div class="image__banner image__item p-absolute" style="--w: 12">
            <img class="w-100 h-100 d-block object-fit-cover" src="./assets/images/banner/banner2.png" alt="banner1" />
        </div>
        <div class="banner__overlay p-absolute"></div>
