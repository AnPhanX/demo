<?php
$sql_scent_list = "SELECT * FROM scent ORDER BY scent_id ASC";
$query_scent_list = mysqli_query($mysqli, $sql_scent_list);
?>
<div class="row">
    <div class="col">
        <div class="header__list d-flex space-between align-center">
            <h3 class="card-title" style="margin: 0;">Danh sách loại sản phẩm</h3>
            <div class="action_group">
                <a href="?action=scent&query=scent_add" class="button button-dark">Thêm loại</a>
            </div>
        </div>
    </div>
</div>
                                ...
                                <tr>
                                    <td>
                                        <a href="?action=scent&query=scent_edit&scent_id=<?php echo $row['scent_id'] ?>">
                                            <div class="icon-edit-ad">
                                                <!-- <img class="w-100 h-100" src="images/icon-edit.png" alt=""> -->
                                                <i class='fas fa-edit' style='font-size:20px;color: #062336'></i>
                                            </div>
                                        </a>
                                    </td>
                                    <td>
