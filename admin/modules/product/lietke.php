                ...
                <div class="main-pane-top d-flex space-between align-center justify-center">
                    <div class="dropdown dropdown__item">
                        ...
                        <?php 
                            ...
                            ?>
                            <a class="dropdown-item" href="index.php?action=product&query=product_list&category_id=<?php echo $category['category_id'] ?>"><?php echo $category['category_name'] ?></a>
                            <?php
                            } 
                            ?>
                        </div>
                                ...
                                <tr>
                                    <td style="padding:18px 22px;">
                                        <a href="?action=product&query=product_edit&product_id=<?php echo $row['product_id'] ?>">
                                            <div class="icon-edit-ad" title="Sửa sản phẩm">
