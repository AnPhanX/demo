                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card-content">
                            ...
                            <div class="input-item form-group">
                                <label for="title" class="d-block">Thuộc bộ sưu tập</label>
                            ...
                            <div class="input-item form-group">
                                <label for="product_scent" class="d-block">Loại sản phẩm</label>
                                <div class="scent-list">
                                    ...
                                    ?>
                                    <a class="btn-add-scent " href="?action=scent&query=scent_add">Thêm Loại</a>
                                </div>
                            </div>
                            <div class="input-item form-group">
