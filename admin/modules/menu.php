        ...
        <li class="nav-item <?php if ($action === 'product' or $action === 'category') { echo "active"; } ?>">
            ...
            <div class="collapse <?php if ($action === 'product' or $action === 'category' or $action === 'collection' or $action === 'brand' or $action === 'scent') { echo "show"; } ?>" id="products">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item <?php if ($query === 'brand_list') { echo "active"; } ?>"> <a class="nav-link" href="index.php?action=brand&query=brand_list">Danh sách bộ sưu tập</a></li>
                    <li class="nav-item <?php if ($query === 'scent_list') { echo "active"; } ?>"> <a class="nav-link" href="index.php?action=scent&query=scent_list">Danh sách loại sản phẩm</a></li>
